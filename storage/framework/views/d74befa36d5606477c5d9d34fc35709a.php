    ...
    >
        <div class="flex items-end justify-center min-h-dvh px-4 pt-4 pb-10 text-center sm:block sm:p-0">
            ...
            <div
                    ...
                    class="relative inline-block w-full align-bottom text-left overflow-hidden transform transition-all sm:my-8 sm:align-middle sm:w-full"
                    id="modal-container"
            ...
            >
                <?php $__empty_1 = true; $__currentLoopData = $components; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $component): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php
                        $title = $component['arguments']['title'] ?? null;
                    ?>
                    <div x-show.immediate="activeComponent == '<?php echo e($id); ?>'" x-ref="<?php echo e($id); ?>" wire:key="<?php echo e($id); ?>">
                        <div page="modal">
                            ...
                            <div class="building-modal show" x-on:click="closeModal()">
                                <div class="modal-content" x-on:click.stop>
                                    <div class="modal-header">
                                        <h2 class="modal-title"><?php echo e($title); ?></h2>
                                        <button class="modal-close" x-on:click="closeModal()">
...
<?php /**PATH /var/www/vhosts/terranovarp.xyz/stg-world.fr/resources/views/vendor/wire-elements-modal/modal.blade.php ENDPATH**/ ?>