        ...
        <div class="admin-card-body">
            <div class="admin-form-grid admin-form-grid-2">
                ...
                <div class="admin-form-group">
                    ...
                    @error('color') <span class="admin-error">{{ $message }}</span> @enderror
                </div>
            </div>
            ...
            <div class="admin-form-group">
                ...
                @error('url') <span class="admin-error">{{ $message }}</span> @enderror
            </div>
            ...
            @if($statusMessage)
                <div class="admin-alert {{ $statusType === 'success' ? 'admin-alert-success' : 'admin-alert-danger' }}">
                    <i class="fas {{ $statusType === 'success' ? 'fa-check-circle' : 'fa-exclamation-triangle' }}"></i>
                    {{ $statusMessage }}
                </div>
            @endif
        </div>
